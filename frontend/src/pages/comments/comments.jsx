...
import { comments_data } from '../../assets/icons/assets';
import CommentTableItem from '../../components/admin/commentTableItem/commentTableItem';
...
const Comments = () => {
  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      ...
      <div className='relative h-4/5 max-w-3xl overflow-x-auto mt-4 bg-white shadow rounded-lg scroll-hide' >
        <table className='w-full text-sm text-gray-500'>
          <thead className='text-xs text-gray-700 text-left uppercase'>
            <tr>
              <th scope='col' className='py-3 px-6'> Blog </th>
              <th scope='col' className='py-3 px-6 max-sm:hidden'> Date </th>
